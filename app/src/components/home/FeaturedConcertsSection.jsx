...
// Gradient text component to match HeroSection
...
const ConcertCard = ({ concert, index }) => {
    // Array of gradient backgrounds for tickets (sama seperti di HeroSection)
    const previewImages = [
...
const FeaturedConcertsSection = () => {
    // Sample data - you can replace with data from your backend
    const concerts = [
        { id: 1, name: 'EDM Festival 2025', venue: 'Metaverse Arena', date: 'Jun 15, 2025', available: 120, total: 500 },
        { id: 2, name: 'Rock Legends', venue: 'Crypto Stadium', date: 'Jul 22, 2025', available: 75, total: 300 },
        { id: 3, name: 'Jazz Night', venue: 'NFT Concert Hall', date: 'Aug 05, 2025', available: 50, total: 100 },
        { id: 4, name: 'Classical Symphony', venue: 'Blockchain Theater', date: 'Sep 18, 2025', available: 25, total: 400 },
    ];

    return (
        <section className="py-16 px-4 min-h-screen bg-gray-900 relative overflow-hidden -mt-px">
            ...
            <div className="max-w-7xl mx-auto relative">
                <div className="flex justify-between items-center mb-10">
                    ...
                    >
                        Featured <GradientText text="Concerts" />
                    </motion.h2>
                    ...
                    >
                        <Link
                            to="/explore"
                            className="text-indigo-400 hover:text-purple-400 font-medium flex items-center"
                        >
                            View all
